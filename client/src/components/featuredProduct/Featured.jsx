      ...
      <div className="pb-6 font-sans text-3xl font-semibold">
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-3 mt-4 md:gap-5 xl:gap-7">
          <div class="row-span-full lg:row-span-2 col-span-full lg:col-span-2 cursor-pointer group flex flex-col bg-[#F9F9F9] rounded-md relative items-center justify-between overflow-hidden">
            ...
            <span class="text-sm left-[5%] absolute top-3.5 md:top-5 3xl:top-7 ltr:left-3.5 rtl:right-3.5 ltr:md:left-5 rtl:md:right-5 ltr:3xl:left-7 rtl:3xl:right-7 bg-black text-white text-10px md:text-sm leading-5 rounded-md inline-block px-2 xl:px-3 pt-0.5 pb-1">
              20%
            </span>
